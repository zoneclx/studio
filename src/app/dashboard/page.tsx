...
import { Code, Archive, Plug, Terminal } from 'lucide-react';
import { Badge } from '@/components/ui/badge';

const quickLinks = [
  { title: 'Web Editor', description: 'Start a new project from scratch.', href: '/create', icon: <Terminal className="w-8 h-8" /> },
