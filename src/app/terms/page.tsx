          ...
          <ScrollArea className="h-[60vh] pr-6">
            <div className="space-y-6 text-muted-foreground">
              <section>
                ...
                <p>
                  By using our application, Mono Studio, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the application. We may revise and update these Terms of Service from time to time in our sole discretion. All changes are effective immediately when we post them.
                </p>
              </section>
              <section>
