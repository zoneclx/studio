          ...
          <div className="space-y-6">
            <Card className="shadow-lg border-primary/20 bg-card/50 backdrop-blur-sm">
              ...
              <CardFooter className="flex-col items-stretch gap-4">
                 <Button onClick={() => onGenerate()} disabled={isPending} size="lg" className="w-full font-bold">
                  ...
                  <div className="space-y-3 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {examplePrompts.map((example, i) => (
                        <Button key={i} variant="secondary" size="sm" onClick={() => onGenerate(example)} disabled={isPending}>
                  ...
                  <CardHeader className="flex-row items-center justify-between">
                    ...
                    {output && !isPending && (
                      <div className="flex items-center gap-2">
                        <Button variant="ghost" size="icon" onClick={handleSave} aria-label="Save code as an HTML file">
                          <Download className="h-4 w-4" />
                        </Button>
                        {canShare && (
                          <Button variant="ghost" size="icon" onClick={handleShare} aria-label="Share generated code">
